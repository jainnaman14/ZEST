...
import { MdError, MdAttachMoney } from 'react-icons/md'
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-rose-50">
      ...
      <div className="relative bg-gradient-to-r from-orange-500 via-red-500 to-rose-500 px-6 pt-14 pb-20 overflow-hidden">
        <div className="absolute inset-0 opacity-20"
          style={{ backgroundImage: 'radial-gradient(circle at 20% 80%, #fbbf24 0%, transparent 55%)' }} />
        <button
          type="button"
          onClick={() => navigate('/')}
        ...
        <div className="relative text-center">
          ...
          <h1 className="text-3xl font-black text-white drop-shadow">Add Food Item</h1>
          <p className="text-white/70 mt-1 text-sm">
            {myShopData ? `Adding to ${myShopData.name}` : 'Create your menu item'}
          </p>
        </div>
      </div>
